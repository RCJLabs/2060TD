...
export type SimEvent =
  ...
  /**
   * `by` and `damageType`: the hit that killed it, a structure's kind or a
   * power's (M29). `armor`: what died, for the page to weigh the kill by
   * (M31); nothing in a battle reads it.
   */
