...
export const SILENT_TUNNELS: MissionDef[] = [
  {
    ...
    unlockNote: 'REQUISITION: BURIED DEPOT, AMBUSH TEAM, SPIDER HOLE',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: DIRECTIONAL MINE, SANDBAG RAMPART',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: FUEL CACHE, GENERATOR CAVE · HQ LEVEL 2',
