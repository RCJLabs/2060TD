...
export const BLUE_LINE: MissionDef[] = [
  {
    ...
    unlockNote: 'REQUISITION: CONTAINER YARD, PEACEKEEPER SECTION, ENGINEER REVETMENT',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: WIRE & CHARGE, HESCO RAMPART',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: FUEL POINT, POWER MODULE · CP LEVEL 2',
