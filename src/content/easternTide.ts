...
export const EASTERN_TIDE: MissionDef[] = [
  {
    ...
    unlocks: ['storageBunker', 'depmg', 'foxhole'],
    unlockNote: 'REQUISITION: STORES PIT, TYPE 67 MG TEAM, FIGHTING PIT',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: POMZ FIELD, GABION WALL',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: FUEL PARK, POWER STATION · HQ LEVEL 2',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: HJ-8 POST, ENGINEERS, BARRACKS, SIGNALS · FRONT LINE OPEN',
