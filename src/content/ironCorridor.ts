...
export const IRON_CORRIDOR: MissionDef[] = [
  {
    ...
    unlockNote: 'REQUISITION: DEEP BUNKER, PKM TEAM, TRENCH SECTION',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: MON-50 FIELD, EARTH BERM',
  ...
  },
  {
    ...
    unlockNote: 'REQUISITION: POL POINT, DIESEL PLANT · BUNKER LEVEL 2',
